...
const loadTranslations = (l) => {
  return fetch(`/i18n/${ l }.json`).then((res) => {
    return res.json();
  });
}
...
class App extends Component {
  ...
  render() {
    ...
    let trans = translationsOverride || translations;

    return (
      <IntlProvider locale={trans.locale} defaultLocale={trans.locale} messages={trans.messages}>
        <div>
          <TranslationsSwitch
